...
<head>
    ...
    <div class="card">
        ...
        <div class="row justify-content-between">
            <div>
                <div class="col-md-12">
                  <form action="{{ route('bbnpayout.bulk-action') }}" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                    @csrf
                ...
                data--submit="{{ route('bbnpayout.bulk-action') }}"
                data-datatable="reload" data-confirmation='true'
                data-title="{{ __('bbnpayout',['form'=>  __('bbnpayout') ]) }}"
                title="{{ __('bbnpayout',['form'=>  __('bbnpayout') ]) }}"
    ...
    <script>
        ...
        window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                  "type"   : "GET",
                  "url"    : '{{ route("bbnpayout.index_data") }}',
                  "data"   : function( d ) {
                    d.search = {
                      value: $('.dt-search').val()
                    };
