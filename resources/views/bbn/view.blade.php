                ...
                <div class="card">
                    <div class="card-body p-30">
                        <div class="service-man-list">
                            @foreach($providerdata->providerBbn as $bbn)
                            <div class="service-man-list__item">
                                <div class="service-man-list__item_header">
                                    ...
                                    <h4 class="service-man-name">{{$bbn->display_name ?? '-' }}</h4>
                                    <a class="service-man-phone" href="{{$bbn->contact_number}}">{{$bbn->contact_number ?? '-' }}</a>
                                </div>
                                <div class="service-man-list__item_body">
                                    <a class="service-man-mail" href="{{$bbn->email}}">{{$bbn->email ?? '-' }}</a>
                                    <p class="service-man-address">{{$bbn->address ?? '-' }}</p>
                                </div>
                            </div>
                            @endforeach
                        </div>
