    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
                    ...
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            <h5 class="font-weight-bold">{{ $pageTitle ?? __('messages.list') }}</h5>
                                <a href="{{ route('bbntype.index') }}" class="float-right btn btn-sm btn-primary"><i class="fa fa-angle-double-left"></i> {{ __('messages.back') }}</a>
                            @if($auth_user->can('bbntype list'))
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {{ Form::model($bbntypedata ?? '',['method' => 'POST','route'=>'bbntype.store', 'data-toggle'=>"validator" ,'id'=>'bbntype'] ) }}
                            {{ Form::hidden('id') }}
                            <div class="row">
