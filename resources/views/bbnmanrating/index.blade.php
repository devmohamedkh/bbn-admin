<x-master-layout>
    ...
    <div class="card">
        ...
        <div class="row justify-content-between">
            <div>
                <div class="col-md-12">
                  <form action="{{ route('bbn-rating.bulk-action') }}" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                    @csrf
                ...
                data--submit="{{ route('bbn-rating.bulk-action') }}"
                data-datatable="reload" data-confirmation='true'
                data-title="{{ __('bbn-rating',['form'=>  __('bbn-rating') ]) }}"
                title="{{ __('bbn-rating',['form'=>  __('bbn-rating') ]) }}"
    ...
    <script>
        ...
        window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                  "type"   : "GET",
                  "url"    : '{{ route("bbn-rating.index_data") }}',
                  "data"   : function( d ) {
                    d.search = {
                      value: $('.dt-search').val()
                    };
